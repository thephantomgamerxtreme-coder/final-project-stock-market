    ...
    <div className="min-h-screen px-5 py-10 sm:py-16">
      <div className="mx-auto max-w-4xl">
        <header className="flex flex-col items-center text-center">
          <img src="/toi-summer-camp.png" alt="Times of India Logo" className="mx-auto mb-6 h-20 object-contain" />
          <Logo size="lg" />
        ...
        <p className="mt-16 text-center text-[11px] leading-relaxed text-muted-foreground/80">
          ...
          AI Summer Camp for students by the Times of India. It teaches about the Stock Market from the chapter Financial Markets from Grade 12 Business Studies.
        </p>
      </div>
    </div>
  );
